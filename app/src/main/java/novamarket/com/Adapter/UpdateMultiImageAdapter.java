...
public class UpdateMultiImageAdapter extends RecyclerView.Adapter{
    /*
      어댑터의 동작원리 및 순서
      ...
      */
      ...
      public UpdateMultiImageAdapter(Context context, ArrayList<UpdateImageDataModels> dataModels){
              ...
              cancle_button.setOnClickListener(new View.OnClickListener() {
                  ...
                  public void onClick(View v) {
                      ...
                      if(dataModels.get(pos).getType() == 0){//서버에서 불러온 이미지
                          ...
                          ((UpdateMarketActivity)UpdateMarketActivity.context_update_market).removeList.add(dataModels.get(pos).getImg());
                      }else {//갤러리에서 가져온 이미지
                      ...
                      ((UpdateMarketActivity)UpdateMarketActivity.context_update_market).countPhoto_update_market.setText(dataModels.size()+"/10");
